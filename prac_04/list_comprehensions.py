...
names_longer_than_11_chars = [name for name in full_names if len(name)>11]
print(names_longer_than_11_chars)
last_names = [name.split()[1] for name in names_longer_than_11_chars]
print(last_names)
